...
class CalculatorApp(App):
    r'''
    button_tercera1 = None
    button_tercera2 = None
    button_cincuenta1 = None
    button_cincuenta2 = None
    button_ciento_cincuenta1 = None
    button_ciento_cincuenta2 = None
    button_doscientos1 = None
    button_doscientos2 = None
    button_renuncio1 = None
    button_renuncio2 = None
    points_input1 = None
    points_input2 = None
    '''
    ...
    def cante(self, button):
        if button.text == 'Borrar':
            ...
            self.team1_counters = {'tercera': 0, 'cincuenta': 0, 'cien': 0, 'ciento_cincuenta': 0, 'doscientos': 0}
            self.team2_counters = {'tercera': 0, 'cincuenta': 0, 'cien': 0, 'ciento_cincuenta': 0, 'doscientos': 0}
        elif button.text == 'Tercera' and button in (self.button_tercera1, self.button_tercera2):
            if button is self.button_tercera1:
                self.team1_counters['tercera'] += 1
                self.points_input1.text = str(int(self.points_input1.text) + 20)
            else:
                self.team2_counters['tercera'] += 1
                self.points_input2.text = str(int(self.points_input2.text) + 20)
        elif button.text == 'Cincuenta' and button in (self.button_cincuenta1, self.button_cincuenta2):
            if button is self.button_cincuenta1:
                self.team1_counters['cincuenta'] += 1
                self.points_input1.text = str(int(self.points_input1.text) + 50)
            else:
                self.team2_counters['cincuenta'] += 1
                self.points_input2.text = str(int(self.points_input2.text) + 50)
        elif button.text == 'Ciento cincuenta' and button in (
        self.button_ciento_cincuenta1, self.button_ciento_cincuenta2):
            if button is self.button_ciento_cincuenta1:
                self.team1_counters['ciento_cincuenta'] += 1
                self.points_input1.text = str(int(self.points_input1.text) + 150)
            else:
                self.team2_counters['ciento_cincuenta'] += 1
                self.points_input2.text = str(int(self.points_input2.text) + 150)
        elif button.text == 'Doscientos' and button in (self.button_doscientos1, self.button_doscientos2):
            if button is self.button_doscientos1:
                self.team1_counters['doscientos'] += 1
                self.points_input1.text = str(int(self.points_input1.text) + 200)
            else:
                self.team2_counters['doscientos'] += 1
                self.points_input2.text = str(int(self.points_input2.text) + 200)
        elif button.text == 'Renuncio' and button in (self.button_renuncio1, self.button_renuncio2):
            if button is self.button_renuncio1:
                self.points_input1.text = str(int(self.points_input1.text) + 0)  # No se incrementa el contador
            else:
                self.points_input2.text = str(int(self.points_input2.text) + 0)  # No se incrementa el contador
